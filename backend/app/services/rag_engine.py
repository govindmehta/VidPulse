...
class VideoRAGOrchestrator:
	...
	async def _context_router(self, state: AgentState) -> str:
	...
	async def _generate_response(self, state: AgentState) -> AgentState:
		...
		system_prompt = (
			"You are a video analytics assistant. Ground every claim in the provided "
			"chunks, cite chunk numbers, and use the engagement_rate values as given. "
